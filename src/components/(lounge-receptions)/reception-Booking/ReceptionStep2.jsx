...
const ReceptionStep2 = ({ bookingDetails, onBack, onNext }) => {
  ...
  return (
    <div className="lg:px-20 px-5 space-y-6 text-primary my-10">
      <div className="text-center"> <span className="text-2xl text-white rounded-full px-4 py-1 bg-primary">Concevez votre réception de A à Z</span></div>
      <p>
