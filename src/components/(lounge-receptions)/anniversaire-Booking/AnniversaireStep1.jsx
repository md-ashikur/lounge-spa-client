...
const AnniversaireStep1 = ({ onNext, setBookingDetails }) => {
  ...
  const weekdaysSlots = [
    { time: "8h – 14h", price: 350 },
    { time: "11h – 18h", price: 450 },
    { time: "18h30 – 1h", price: 490 },
  ];

  const fridaySaturdaySlots = [
  ...
  const sundaySlots = [
    { time: "11h – 18h", price: 490 },
    { time: "12h30 – 18h", price: 350 },
    { time: "18h30 – 1h", price: 590 },
  ];
  ...
  const updateTimeSlots = () => {
    ...
    if (day === 0) {
      setAvailableSlots(sundaySlots); // Sunday
    } else if (day === 5 || day === 6) {
      setAvailableSlots(fridaySaturdaySlots); // Friday or Saturday
    } else {
      setAvailableSlots(weekdaysSlots); // Weekdays (Monday to Thursday)
    }
  };
