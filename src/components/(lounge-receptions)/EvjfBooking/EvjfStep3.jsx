...
const EvjfStep3 = ({ bookingDetails, onBack, onNext }) => {
  ...
  return (
    <div className="lg:px-20 my-10 space-y-6 text-primary">
      ...
      <div>
        ...
        <p>
          <b>Date :</b>{" "}
          {bookingDetails?.date?.toDateString() || "Non disponible"}
        </p>
        ...
        <p>
          <b>Nombre de personnes :</b> {bookingDetails?.people || 0}
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          ...
          {selectedAccommodation?.price * numAccommodations}€ 
        </p>
      </div>
