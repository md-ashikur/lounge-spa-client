    ...
    <div className="lg:px-10 space-y-6 my-10">
      <div className="text-center">
        ...
        <p className="text-primary">
          Découvrez un univers d&apos;exception pour un événement
          d&apos;entreprise inoubliable. 300m², digne d’un palais des 1001 nuits
          et des menus personnalisés inventif à base de produits frais et de
          saison proposé par notre cheffe sur place. offrez à vos collaborateurs
